...
class Toplevel1:
    def __init__(self, top=None, root_parent=None):
        ...
        self.EntryOldName.configure(cursor="watch")
        ...
        self.Label_NewPhone.place(relx=0.052, rely=0.269, height=21, width=89
                , bordermode='ignore')
        self.Label_NewPhone.configure(cursor="watch")
        ...
        self.Label_NewNote.place(relx=0.069, rely=0.385, height=21, width=79
                , bordermode='ignore')
        self.Label_NewNote.configure(cursor="watch")
        ...
        self.Entry_NewName.configure(cursor="watch")
        ...
        self.Entry_NewPhone.configure(cursor="watch")
        ...
        self.Entry_NewNote.configure(cursor="watch")
        ...
        self.Entry_NewAddress.configure(cursor="watch")
